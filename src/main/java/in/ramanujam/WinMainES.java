...
public class WinMainES {
    ...
    public static void main(String[] args) {
        ...
        ExposedPort tcp6379 = ExposedPort.tcp(9200);
        Ports portBindings = new Ports();
        portBindings.bind(tcp6379, new Ports.Binding("localhost", "7777"));

        CreateContainerResponse container = dockerClient.createContainerCmd("elasticsearch") // TODO: check that we are not duplicating containers
